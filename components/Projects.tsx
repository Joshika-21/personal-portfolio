...
//           <motion.div
//             key={index}
//             className="bg-gradient-to-br from-[#1a1b33] to-[#2c2e4b] rounded-3xl shadow-xl overflow-hidden cursor-pointer hover:scale-105 transition-transform duration-300"
...
//                   <span
//                     key={i}
//                     className="px-4 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-500 to-pink-500 rounded-full shadow-md"
//                   >
//                     {tech}
//                   </span>
//                 ))}
//               </div>
//               <h3 className="text-2xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 via-purple-400 to-cyan-400">
//                 {project.title}
//               </h3>
//             </div>
//           </motion.div>
...
//           >
//             <motion.div
//               className="bg-gradient-to-br from-[#1a1b33] to-[#2c2e4b] p-10 rounded-3xl max-w-2xl mx-4 text-left shadow-2xl"
...
//                 width={800}
//                 height={400}
//                 className="w-full object-contain max-h-[300px] rounded-2xl mb-6"
//               />
...
//                   <span
//                     key={i}
//                     className="px-4 py-2 rounded-full bg-gradient-to-r from-purple-500 to-pink-500 text-white font-semibold text-sm shadow-md"
//                   >
//                     {techItem}
//                   </span>
//                 ))}
      ...
      <AnimatePresence>
        {selectedProject && (
          <motion.div className="fixed inset-0 bg-black/80 backdrop-blur-sm flex items-center justify-center z-50">
            <motion.div className="bg-gradient-to-br from-[#1a1b33] to-[#2c2e4b] p-10 rounded-3xl max-w-xl mx-4 shadow-2xl"
              initial={{ scale: 0.8, y: -50 }}
              animate={{ scale: 1, y: 0 }}
              exit={{ scale: 0.8, y: -50 }}
              transition={{ type: 'spring', stiffness: 200, damping: 20 }}>
